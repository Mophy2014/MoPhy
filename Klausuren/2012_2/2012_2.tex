...
\begin{align*}
T_1		&= \frac 12 m_1 \dot{\vec r}_1^2	\\
		&= \frac 12 m_1 \left(\frac{d}{dt} \vecz{l_1 \sin \phi_1}{l_1 \cos \phi_1}\right)^2 \\
		&= \frac 12 m_1 l_1^2 \dot \phi_1 \underbrace{\vecz{\cos \phi_1}{-\sin \phi_1}^2}_{1}\\
		&= \frac 12 m_1 l_1^2 \dot \phi_1	\\
T_2 	&= \frac 12 m_2 \dot{\vec r}_2^2	\\
		&= \frac 12 m_1 \left(\frac{d}{dt} 
		\vecz{l_1 \sin \phi_1 + l_2 \sin \phi_2}
			 {l_1 \cos \phi_1 + l_2 \cos \phi_2}
		\right)^2 \\
		&= \frac 12 m_1
		\vecz{\phantom{-} \dot\phi_1 l_1 \cos \phi_1 + \dot\phi_2 l_2 \cos \phi_2}
			 {			 -\dot\phi_1 l_1 \sin \phi_1 - \dot\phi_2 l_2 \sin \phi_2}
		^2 \\
		&= \frac 12 m_1
		\left(
		( \dot\phi_1 l_1 \cos \phi_1 + \dot\phi_2 l_2 \cos \phi_2)^2\\
		&+ ( \dot\phi_1 l_1 \cos \phi_1 + \dot\phi_2 l_2 \cos \phi_2)
		  (-\dot\phi_1 l_1 \sin \phi_1 - \dot\phi_2 l_2 \sin \phi_2)
		&+ (-\dot\phi_1 l_1 \sin \phi_1 - \dot\phi_2 l_2 \sin \phi_2)^2
		\right)
\end{align*}
\end{enumerate}
...
\[\braket{E} = \braket{\psi|E\hat H|\psi}\]
an.
\item[Lösung:]
\begin{align*}
